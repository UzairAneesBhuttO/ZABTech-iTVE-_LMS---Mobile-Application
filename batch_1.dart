...
class Batch_1 extends StatefulWidget {
  var uid;
  Batch_1(this.uid);

  @override
  State<Batch_1> createState() => _Batch_1State(uid);
}

class _Batch_1State extends State<Batch_1> {
  @override
  var uid;
  _Batch_1State(this.uid);
  @override
  var name;
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                              builder: (Context) => Batch_Teacher(uid),
                            ),
                          );
                        },
