...
class Batch_Teacher extends StatefulWidget {
  var uid;
  Batch_Teacher(this.uid);

  @override
  State<Batch_Teacher> createState() => _Batch_TeacherState(uid);
}

class _Batch_TeacherState extends State<Batch_Teacher> {
  @override
  @override
  var uid;
  _Batch_TeacherState(this.uid);
  @override
  var name;
