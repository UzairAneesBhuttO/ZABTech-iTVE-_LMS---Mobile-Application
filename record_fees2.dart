...
import 'package:zabtech_education/record/get_fees1.dart';

class Fees_Record2 extends StatefulWidget {
  var uid;
  Fees_Record2(this.uid);

  @override
  State<Fees_Record2> createState() => _Fees_Record2State(uid);
}

class _Fees_Record2State extends State<Fees_Record2> {
  var uid;
  _Fees_Record2State(this.uid);
  @override
  var name;
