...
import 'package:zabtech_education/record/record_exam2.dart';

class Exam_Record1 extends StatefulWidget {
  var uid;
  Exam_Record1(this.uid);

  @override
  State<Exam_Record1> createState() => _Exam_Record1State(uid);
}

class _Exam_Record1State extends State<Exam_Record1> {
  @override
  var Name = "";
  var FName = "";
  var RegNo = "";
